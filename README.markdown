 ...
 * Now also with module for [Play Framework 1.x](https://github.com/mbknor/ddsl-playframework-module), [Play Framework 2.0](https://github.com/mbknor/ddsl-play2-module) and [Dropwizard](https://github.com/mbknor/ddsl-dropwizard)
